...
Una empresa siempre querrá los mejores resultados pero un buen líder siempre sabe hasta dónde puede rendir su equipo sin quemarlo. Normalmente buscamos objetivos exigentes pero es importante tomar en cuenta al equipo, pues en la medida en que se incluye al equipo para planear, más integrados se sentirán y luego más motivados a cumplirlos.

Hay dos tipos de objetivos que desmotivan a las personas:
* Objetivos inalcanzables que los hacen sentir lejos
* Objetivos fáciles que los aburren y se distraen

Para involucrar al equipo, podemos hacer una dinámica con el uso de post-its y los íconos de:
* Un castillo
* Dos dragones
* Un guerrero para cada persona del equipo
* Una caja de herramientas

La dinámica consiste en lo siguiente.

1. El castillo representará el objetivo que se quiere alcanzar.
2. Un dragón representa los agentes externos que nos pueden frustrar el objetivo, alrededor, cada quién colocará lo que considera como tal. Se colocará lejos del castillo.
3. El otro dragón, representará los factores internos y se sigue la misma mecánica pero este se colocará más cerca del castillo.
4. La caja de herramientas se colocará a un costado del castillo y cada persona aportará las herramientas que considera útiles.
5. Los guerreros, representarán a cada uno de los integrantes, donde escribirán cuáles serán sus acciones para lograr el objetivo.
6. Al final se hará un plan con fechas y objetivos.

## Crear un ambiente de motivación
Para crear un ambiente de motivación, es importante el bienestar físico y psicológico de las personas, por ello el espacio donde se desenvuelven debe ser limpio y cómodo. Si se trabaja de manera remota se deben incentivar las lluvias de ideas y el diálogo, ya que esto propicia la creatividad, el estímulo mental, el feedback y la confianza.

* Siempre es bueno que todos entiendam los alcances de cada rol en el equipo, esto invita a la colaboración.
* Dejar claro qué expectativa se tiene de las personas.
...
* Stickers circulares
* Marcadores
* Dos papeles de rotafolio: uno con ejes XY y otro con dibujo de un barco en el centro.
* Temporizador

La dinámica consiste en:
Podemos usar este [playlist](https://open.spotify.com/playlist/6PMm6utBmLJ13SGSgZE5Gu?si=1yFbtXwsSQShpDQKriN6Tw)
* Identificar el objetivo a tratar
* Empezar pidiéndoles que escriban en los post-its de un solo color lo que creen que está funcionando bien, tendrán 5 min y los pegarán a los lados y encima del barco.
* Luego se les pedirá que escriban los problemas que visualizan en post-its de otro color, estos se pondrán debajo del barco. El ejercicio puede ser anónimo.
* Se les pedirá que pongan un sticker a modo de voto en los problemas que consideren más grandes.
* Se les pedirá que escriban las posibles soluciones a esos problemas en post-its de otro color.
* Se les pedirá que voten por las soluciones más óptimas.
* Cada solución se colocará en un g´rafico Impacto/esfuerzo, donde habrá cuatro cuadrantes:
...
Luego se debe tomar decisiones dependiendo qué soluciones hayan quedado en los cuadrantes: Inmediato, largo plazo y tareas en un lapso máximo de dos semanas, el efecto de este plan debe ser medible.

## Lidiar con desafíos desesperados
Persuadir con argumentos será una habilidad que habrá que desarrollar, algunas funcionan mejor con ciertas personas. Las *crisis existenciales* son reales y se presentan con mayor fuerza en algunas personas que en otras: hay que estar preparados para darles certidumbre.

> Pensemos que el equipo está antes de un choque de auto: algunos estarán enojados, otros no sabrán si seguir o irse. Nuestra ventaja es que podemos irnos a un punto lejano y darles a entender qué camino seguir.

Para esto podemos hacer una plática 1 a 1 y también las siguientes actividades:
1. Entregar tres hojas en blanco: una vez que diga tengo miedo de X por causa de Y, con esto se aterrizará el problema; luego en la hoja hará tres columnas:
  * Definir: las peores consecuencias que puede traer la situación.
  * Prevenir: qué reduce la probabilidad de que esas cosas sucedan.
  * Reparar: en dado caso, qué harías para reparar el daño.
  Este ejercicio servirá para entender que la solución no es A o B.
  Después preguntando cuáles son los beneficios parciales o totales de la situación, los listará en la hoja dos.
  Luego en la tercera hoja hará una lista de cuál es el costo económico, emocional o físico de no tomar la decisión.
  Al final, es importante concluir que no todo es blanco o negro y que continuar haciendo lo mismo de siempre no es garantía de mejora.
2. Grow. Se le entrega una hoja y lapicero a la persona, donde escribirá las siglas GROW y la siguiente información en cada letra:
  * Goals: Cuál es la meta de mnera concisa.
  * Reality: Hacerle preguntas sin juzgar para que reflexione su propósito (siempre llegar a accionables).
  * Options: Cuáles son las opciones (ambos las definen) para cumplir la meta.
  * Will. Acciones que la persona se compromete a llevar a cabo.
  Al final del ciclo se evalúa el avance que se tiene con las acciones comprometidas o hay nuevas dificultades.
